...
public class TestTailSimpleMoving : MonoBehaviour {
	...
	public float slowTurnSpeed = 10, speed = 0, angularSpeed = 20, power = 100, breaks = 100, friction = 0.01f, maxSpeed = 100;
	...
	void Update () {
		/*text.text = "speed = " + speed 
			+ ", steering speed = " + angularSpeed 
			+ ", engine power = " + power 
			+ ", breaks power = " + (power + breaks) 
			+ ", forward friction = " + friction 
			+ ", max speed = " + maxSpeed;
*/
		//Debug.Log (log);
