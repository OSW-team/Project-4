...
public class CombineChildren : MonoBehaviour {
	...
	public bool generateTriangleStrips = false, combineOnStart = false, destroyAfterOptimized = true, castShadow = true, receiveShadow = true, keepLayer = true;
	...
	public void Combine () {
		...
		for (int i=0;i<filters.Length;i++) {
            if (!filters[i].CompareTag("NonCombinable")&&!filters[i].CompareTag("CombineSecond")) 
            {
